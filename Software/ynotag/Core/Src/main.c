...
char buffer[128];
uint16_t palette[7] = {BLACK, WHITE, GREEN, BLACK, BLACK, BLACK, WHITE};
uint16_t  image[360][2] = {{1, 1497}, {0, 1}, {1, 15}, {0, 1}, {1, 46}, {2, 1}, {1, 1}, {0, 1}, {1, 13}, {2, 1}, {1, 1}, {0, 1}, {1, 45}, {2, 1}, {1, 2}, {0, 1}, {1, 11}, {2, 1}, {1, 2}, {0, 1}, {1, 44}, {2, 1}, {1, 4}, {0, 1}, {1, 9}, {2, 1}, {1, 4}, {0, 1}, {1, 43}, {2, 1}, {1, 4}, {0, 1}, {1, 9}, {2, 1}, {1, 4}, {0, 1}, {1, 43}, {2, 1}, {1, 5}, {2, 9}, {1, 5}, {0, 1}, {1, 43}, {2, 1}, {3, 4}, {4, 1}, {3, 9}, {2, 1}, {1, 4}, {0, 1}, {1, 43}, {2, 1}, {3, 3}, {4, 1}, {3, 11}, {2, 1}, {1, 3}, {0, 1}, {1, 43}, {2, 1}, {3, 2}, {4, 1}, {3, 13}, {2, 1}, {1, 2}, {0, 1}, {1, 43}, {2, 1}, {3, 1}, {4, 1}, {3, 15}, {2, 1}, {1, 1}, {0, 1}, {1, 44}, {4, 2}, {1, 15}, {0, 2}, {1, 46}, {4, 1}, {1, 15}, {0, 1}, {1, 46}, {4, 1}, {5, 2}, {4, 3}, {5, 7}, {4, 3}, {1, 2}, {0, 1}, {1, 45}, {4, 1}, {5, 1}, {1, 1}, {4, 3}, {1, 7}, {5, 3}, {4, 1}, {1, 1}, {0, 1}, {1, 45}, {4, 1}, {1, 1}, {6, 2}, {1, 2}, {4, 1}, {1, 5}, {6, 1}, {1, 2}, {4, 2}, {1, 1}, {0, 1}, {1, 45}, {4, 1}, {1, 1}, {6, 2}, {1, 2}, {4, 1}, {1, 5}, {6, 1}, {1, 2}, {4, 2}, {1, 1}, {0, 1}, {1, 45}, {4, 1}, {3, 1}, {6, 1}, {1, 1}, {4, 3}, {1, 5}, {6, 3}, {3, 1}, {4, 1}, {1, 1}, {0, 1}, {1, 45}, {4, 1}, {3, 2}, {1, 1}, {4, 2}, {1, 7}, {3, 2}, {4, 1}, {1, 2}, {0, 1}, {1, 45}, {4, 1}, {5, 7}, {4, 3}, {1, 7}, {0, 1}, {1, 46}, {4, 1}, {5, 5}, {4, 5}, {1, 5}, {0, 1}, {1, 48}, {4, 1}, {1, 13}, {0, 1}, {1, 50}, {4, 1}, {3, 3}, {4, 1}, {3, 3}, {4, 1}, {1, 3}, {0, 1}, {1, 52}, {4, 1}, {1, 9}, {0, 1}, {3, 54}, {4, 2}, {3, 5}, {0, 2}, {3, 55}, {4, 1}, {3, 1}, {4, 5}, {3, 1}, {0, 1}, {1, 51}, {4, 4}, {5, 2}, {4, 5}, {1, 2}, {0, 4}, {1, 46}, {2, 1}, {3, 2}, {4, 1}, {5, 4}, {4, 3}, {3, 4}, {2, 1}, {1, 2}, {0, 1}, {1, 44}, {2, 1}, {3, 3}, {4, 1}, {3, 11}, {2, 1}, {1, 3}, {0, 1}, {1, 42}, {2, 1}, {3, 4}, {4, 1}, {3, 11}, {2, 1}, {1, 4}, {0, 1}, {1, 41}, {2, 1}, {3, 3}, {4, 1}, {3, 13}, {2, 1}, {1, 3}, {0, 1}, {1, 41}, {2, 1}, {3, 3}, {4, 1}, {3, 13}, {2, 1}, {1, 3}, {0, 1}, {1, 41}, {2, 1}, {3, 3}, {4, 1}, {3, 13}, {2, 1}, {1, 3}, {0, 1}, {1, 41}, {2, 1}, {3, 2}, {4, 1}, {3, 15}, {2, 1}, {1, 2}, {0, 1}, {1, 41}, {2, 1}, {3, 1}, {4, 1}, {3, 5}, {4, 1}, {3, 5}, {4, 1}, {3, 5}, {2, 1}, {1, 1}, {0, 1}, {1, 41}, {3, 1}, {4, 1}, {3, 6}, {4, 1}, {3, 5}, {4, 1}, {3, 6}, {1, 1}, {0, 1}, {1, 42}, {4, 1}, {3, 6}, {4, 1}, {3, 2}, {4, 1}, {3, 2}, {4, 1}, {1, 6}, {0, 1}, {1, 43}, {4, 1}, {3, 5}, {4, 1}, {3, 3}, {4, 1}, {3, 3}, {4, 1}, {1, 5}, {0, 1}, {1, 2}, {0, 3}, {3, 38}, {4, 1}, {3, 5}, {4, 1}, {3, 3}, {4, 1}, {3, 3}, {4, 1}, {3, 5}, {1, 1}, {4, 2}, {1, 3}, {0, 4}, {3, 33}, {4, 1}, {3, 4}, {4, 3}, {3, 3}, {4, 1}, {3, 3}, {4, 3}, {3, 4}, {4, 1}, {1, 8}, {0, 1}, {3, 31}, {4, 1}, {3, 5}, {4, 1}, {3, 5}, {4, 1}, {3, 5}, {4, 1}, {3, 5}, {4, 1}, {1, 8}, {0, 1}, {3, 30}, {1, 25}, {0, 9}};
volatile float lat;
volatile float lon;
