...
volatile uint16_t palette[10] = { YELLOW, GREEN, BLUEGREEN, DARKBLUEGREEN, GREYGREEN, WHITE, GREY, GREYPINK, OUTLINE,BLACK };
		...
		case Main:
			...
			if (updateScreen >= 5) {
				...
				case 2:
					...
					Animate(animAdultSitting, 0, 20, 30, 80, 80);
					break;
				}
